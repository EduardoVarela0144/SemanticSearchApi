...
@articles_routes.route('/article/triplets_semantic_search', methods=['GET'])
...
@articles_routes.route('/article/download_triplets_csv', methods=['GET'])
def download_triplets_csv():
    return article_controller.export_triplets_to_csv(request)

@articles_routes.route('/article/download_triplets_sql', methods=['GET'])
