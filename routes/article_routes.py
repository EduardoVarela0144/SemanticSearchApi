...
@articles_routes.route('/triplet/get_all_triplets', methods=['GET'])
def get_all_triplets():
    return article_controller.get_all_triplets()
...
@articles_routes.route('/triplet/triplets_semantic_search', methods=['GET'])
...
@articles_routes.route('/triplet/download_triplets_csv', methods=['GET'])
def download_triplets_csv():
    return article_controller.export_triplets_to_csv(request)

@articles_routes.route('/triplet/download_triplets_sql', methods=['GET'])
